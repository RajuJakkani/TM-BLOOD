...
#models
from .models import Patient,Document,TestResult,Label
...
class PatientCreateView(CreateView):
    ...
    fields = ('fname','lname','address','zip')  # or  __all__
    # context_object_name = 'patient'
    def get_success_url(self):
        return reverse('patient_profile', kwargs={'pk':self.object.id})
...
class GeneratedReportedView(View):
    ...
    def create_comparison(self, previous_doc, present_doc, all_labels):
        pass
    ...
    #     }
        ...
        #     testresult1 = TestResult.objects.filter(document=present_report)
